...
let prechmelody = n(`<
{[c#4, [b4@0.8 a4@0.2]]@2.5 [e4 e4]@0.5 [e4 f#4 e4 d4] [c#4 [e4 e4]] [e4 f#4 e4 d4] [c#4]@1.5 ~@0.5}
>`)
  .scale("C2:chromatic").slow(2)
  .sound("gm_electric_guitar_muted:6")
...
{[[a4 a4] b4] a4 [d4 d4 d4 e4] [d4 b3]@0.5 ~ [e4 e4]@0.5 [[e4 f#4] e4] c#4 [e4@0.25 f#4@0.75] e4@0.5}!4
>`).gain(1)
  .scale("C2:chromatic").slow(2)
  .sound("gm_violin")
  .release(0.3).attack(0.2).drive(0.1).decay(0.4).lpf(1500).sustain(0.7)
...
>`).gain(0.5)
  .scale("C2:chromatic").slow(2)
  .sound("gm_violin")
  .release(0.4).attack(0.2).drive(0.1).decay(0.4).lpf(1500).sustain(0.7)
  .room(1.5).pan(tri.slow(2))
...
let bassch = n(`<
{[b2 b2] b2 [g1 [g1 g1]] g2 [d1 [d1 d1]] d2 a2 f#2}!8>`)
  .scale("C2:chromatic")
  .slow(2)
  .sound("supersaw").sustain(0.7)
  .release(0.1)
...
//chorus
$: stack(
  chorus.postgain(0.7)._punchcard(), 
  lowchorus.postgain(0.7)._punchcard(),
